...
<html>
	...
	<body>
		<div id="edit-autor" class="col-sm-12" role="main">
			<div class="container">
				<g:form id="formEditAutor" enctype='multipart/form-data' url="[resource:autorInstance, action:'update']" method="PUT">
					<div class="menu navbar-collapse" role="navigation">
						<ul class="navbar-nav">
							<li><g:submitButton name="create" class="btn btnSave" value="${message(code: 'default.button.update.label', args: [message(code: 'layoutMenu.botonesColeccion.autor')])}" /></li>
