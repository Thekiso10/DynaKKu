...
<html>
	...
	<body>
		<a href="#create-mangas" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-mangas" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:mangasInstance, action:'save']" >
				<fieldset class="form">
